...
setup_letsencrypt() {
  ...
  echo "api.ia-resume.com www.api.ia-resume.com" > domains.txt
  echo "ia-resume.com www.ia-resume.com" > domains.txt
...
if [ "$CA_SSL" = "true" ]; then
  ...
  cp $SSL_ROOT/certs/api.ia-resume.com/fullchain.pem $SSL_ROOT/certs/api.ia-resume.com/privkey.pem $SSL_CERT_HOME
